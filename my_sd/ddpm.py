...
class DDPMSampler:
    ...
    def __init__(self, generator: torch.Generator, num_training_steps=1000, beta_start:float = 0.00085, beta_end:float=0.0120):
        ...
        self.alpha_cumprod = torch.cumprod(self.alphasm,0)
    ...
    def step(self, timestep: int, latents: torch.Tensor, model_output:torch.Tensor):
        ...
        # Compute the coefficients for pred_original_sample and current x_t
    ...
    def add_noise(self, original_samples: torch.FloatTensor, 
        ...
        sqrt_one_minus_alpha_prod = (1-alpha_cumprod)**0.5 # standard deviation
